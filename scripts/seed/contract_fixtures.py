...
As used in this Agreement, the following capitalized terms shall have the respective meanings assigned below:
...
Target shall initiate all purchases of Products via electronic transmission of EDI 850 Purchase Orders. Each Purchase Order constitutes an offer by Target to purchase the specified quantities of Products under the prices, freight terms, and delivery schedules set forth therein.

### 2.2 EDI Purchase Order Acknowledgment (EDI 855)

Vendor shall transmit an electronic Purchase Order Acknowledgment (EDI Transaction Set 855) or functional acknowledgment (EDI 997) within twenty-four (24) hours following Vendor’s receipt of each EDI 850. The EDI 855 must confirm Vendor’s acceptance of the PO, committed quantities per line item, and scheduled ship dates conforming to the designated MABD. If Vendor fails to transmit an explicit rejection of a Purchase Order within twenty-four (24) hours of receipt, the Purchase Order shall be deemed accepted in its entirety as issued. Any unilateral modification, conditional acceptance, or differing terms inserted by Vendor in an EDI 855 or invoice are expressly rejected and void *ab initio*.

### 2.3 Order Modifications and Cancellations

Target reserves the right to modify, reschedule, or cancel any unfulfilled Purchase Order, or portion thereof, without liability or restocking fee, upon providing electronic or written notice to Vendor at least five (5) Business Days prior to the scheduled origin shipping date.

### 2.4 Non-Binding Forecasts

Any demand projections, rolling volume forecasts, or historical sales trends supplied by Target to Vendor are non-binding estimates provided solely for manufacturing planning purposes. Nothing herein shall obligate Target to issue Purchase Orders for any minimum volume or dollar amount of Products.

---

## 3. LOGISTICS ROUTING, FREIGHT TERMS, AND MABD DELIVERY WINDOWS

### 3.1 Freight and Title Terms

Unless expressly designated otherwise on the applicable Purchase Order, all shipments under this Agreement shall move on a prepaid freight basis under Delivered Duty Paid (DDP - Incoterms 2020) terms to Target’s designated receiving facility dock. Vendor shall bear full operational responsibility, carrier freight costs, insurance, and risk of loss or transit damage until Products have been physically offloaded onto Target’s dock and Target has executed an electronic receipt scan.

### 3.2 Must Arrive By Date (MABD) Compliance Window

Target operates a precision-scheduled cross-dock and flow-through distribution network. Every Purchase Order carries a strict Must Arrive By Date (MABD) delivery window:
...
### 4.4 Purchase Order Shortage Penalty

Where the quantity of conforming Products delivered on any individual Purchase Order line falls below ninety-five percent (95.0%) of the ordered unit quantity, Target shall assess, and Vendor shall pay via invoice deduction, a Shortage Non-Compliance Fee equal to three percent (3.0%) of the total purchase order invoice value of the unfulfilled (shorted) merchandise. Products omitted from delivery shall not be backordered; Target reserves the right to automatically cancel the unfulfilled quantity without further liability.
...
Vendor represents, warrants, and covenants to Target that:
...
Force Majeure shall specifically exclude: general market raw material shortages, packaging component delays, price fluctuations, routine mechanical breakdowns, driver shortages, or carrier freight rate negotiations.

### 9.3 Notice and Mitigation
...
### 1.2 Document Priority

In the event of any conflict between this Agreement and any Purchase Order, shipment manifest, routing guide, or vendor portal communication, the explicit terms of this Agreement shall govern and prevail.

---

## 2. ORDER TRANSMISSION, EDI PROTOCOLS, AND SUPPLY CHANNELS

### 2.1 Electronic Purchase Order Generation (EDI 850)

All procurement transactions shall be initiated through EDI 850 Purchase Orders. Each PO shall specify whether the fulfillment channel is designated as Distribution Center (DC) delivery or Direct Store Delivery (DSD).

### 2.2 Purchase Order Acknowledgment (EDI 855)

Vendor shall electronically transmit an EDI 855 Purchase Order Acknowledgment within twenty-four (24) hours of receipt of each EDI 850. The acknowledgment must confirm full acceptance of ordered item quantities and commitment to the delivery schedule. Failure to transmit an explicit rejection within twenty-four (24) hours shall constitute irrevocable deemed acceptance of the Purchase Order as transmitted.
...
### 5.1 Shelf-Stable Wet Nutrition and Pouch Integrity Standards

Vendor manufactures and supplies wet canned pet food (incorporating pull-tab / easy-open aluminum and steel ends) and hermetically sealed retort flexible pouches (including *Cesar®* loaf tubs and *Whiskas®* pouches). Vendor warrants that all primary containers are hermetically sealed, commercially sterile, and free from micro-punctures, pinholes, delamination, or defective crimping.

### 5.2 Temperature Compliance in Transit

During all transit and staging stages, Products must be maintained within approved environmental temperature ranges:
...
### 5.3 Defective Lot Rejection

Kroger receiving personnel shall conduct visual and physical inbound inspections. Kroger reserves the right to reject an entire inbound lot or full truckload shipment if:
...
### 5.4 Return Processing and Handling Fee

For any shipment or lot rejected pursuant to Section 5.3 that is returned to Vendor or directed to certified destruction at Kroger’s facility, Vendor shall be liable for all actual freight and landfill/destruction expenses, and in addition, Kroger shall assess an administrative **Return Handling Fee equal to eight percent (8.0%)** of the total gross purchase order wholesale value of the rejected lot. Vendor acknowledges that handling contaminated, leaking, or damaged wet pet food requires specialized hazardous waste sanitation, dock cleanup, and disposal protocols justifying said 8.0% chargeback.

---

## 6. COMMERCIAL INVOICING, CREDIT TERMS, AND DIRECT STORE DELIVERY

### 6.1 Invoicing via EDI 810

Invoices shall be submitted electronically via EDI 810 following freight departure. Invoices must reference the corresponding Kroger PO number, destination facility code, validated line quantities, and negotiated unit prices.

### 6.2 Payment Terms

Undisputed invoices shall be paid Net sixty (60) days following the date of complete physical receipt and electronic acceptance of conforming Products at the destination DC or retail store.

### 6.3 DSD Receiving and Scan-Back Verification

For all Direct Store Delivery (DSD) orders:
...
### 6.4 Automated Set-Off and Deduction

Kroger shall be entitled to deduct and set off any accrued late delivery fees, pallet rescheduling fees, order shortage chargebacks, ASN fines, return handling fees, and indemnity obligations directly against any current or future accounts payable remittances due to Vendor.

---

## 7. CHARGEBACK DISPUTE PROCEDURE AND AUDIT RECONCILIATION

### 7.1 Mandatory 45-Day Dispute Window

If Vendor disputes any operational compliance deduction, late appointment charge, fill rate penalty, ASN chargeback, or return handling fee deducted by Kroger, Vendor must initiate a formal claim through the **Kroger Vendor Portal (Kroger AP / Chargeback Dispute Portal)** within **forty-five (45) calendar days** following the date of the remittance advice indicating the deduction. Any dispute not formally submitted within said forty-five (45) day window shall be permanently time-barred, forfeited, and deemed accepted by Vendor.

### 7.2 Mandatory Documentary Evidence

To substantiate any dispute regarding on-dock appointment timing, delivery quantities, or ASN transmission, Vendor must upload the following mandatory documents into the Kroger Vendor Portal:
...
### 8.2 Pathogen Surveillance and Microbial Standards

Vendor shall maintain robust environmental monitoring and finished product testing protocols for *Salmonella spp.*, *Listeria monocytogenes*, enterobacteria, and mycotoxins. Finished pet food lots exhibiting positive pathogen findings shall not be distributed to Kroger under any circumstances.

### 8.3 Audit Rights

Kroger food safety quality assurance auditors shall have the contractual right, upon forty-eight (48) hours advance written notice, to enter and inspect Vendor’s manufacturing and distribution facilities during normal business hours to verify FSMA compliance, sanitation records, pest control logs, and third-party Global Food Safety Initiative (GFSI) audit certifications (e.g., SQF or BRC).
...
### 2.1 Order Placement via EDI 850

Costco shall transmit all purchase orders electronically utilizing EDI Transaction Set 850. Each Purchase Order constitutes a binding purchase commitment upon electronic acknowledgment by Vendor.

### 2.2 Purchase Order Acknowledgment (EDI 855)

Vendor shall transmit an electronic Purchase Order Acknowledgment (EDI Transaction Set 855) or functional acknowledgment (EDI 997) within twenty-four (24) hours following Vendor’s receipt of each EDI 850. The EDI 855 must confirm Vendor’s full acceptance of the PO, confirmed line-item case quantities, unit pricing, and scheduled shipping origin dates aligned with Costco’s designated delivery schedule. Any conditional acceptance, price variation, or quantity reduction submitted by Vendor without Costco’s prior written consent is void *ab initio*.

### 2.3 Cancellations and Rescheduling

Costco reserves the right to cancel, modify, or reschedule any Purchase Order without penalty, restocking fee, or storage liability upon transmitting electronic notice to Vendor at least five (5) Business Days prior to the scheduled origin shipping date.

### 2.4 Rolling Volume Projections

Any demand forecasts, promotional volume estimates, or member purchasing projections provided by Costco are non-binding estimates provided solely to assist Vendor in raw ingredient and packaging procurement. Costco makes no guarantee, express or implied, regarding minimum purchase volumes.

---

## 3. DEPOT LOGISTICS, APPOINTMENT SCHEDULING, AND INBOUND ROUTING

### 3.1 Freight Terms and Title Transfer

Unless explicitly stated otherwise on the face of the Purchase Order, all shipments under this Agreement shall move on a prepaid freight basis under Delivered Duty Paid (DDP - Incoterms 2020) terms to the designated Costco Depot dock. Vendor retains title, risk of loss, and full transit insurance responsibility until the trailer is safely positioned at Costco’s depot dock, offloaded, and an authorized Costco receiving agent signs the electronic delivery receipt.
...
Purchase prices are firm, net wholesale prices established on the face of the Purchase Order. Unit prices are all-inclusive, covering product formulation, packaging, club tray display materials, palletization, shrink-wrapping, inland freight, fuel surcharges, and destination unloading. Pricing shall remain fixed for twelve (12) month intervals and may only be modified upon mutual written agreement executed at least ninety (90) days prior to the effective date.

### 5.2 Electronic Invoicing (EDI 810)

Invoices must be transmitted via EDI Transaction Set 810 following origin carrier dispatch. Each invoice must precisely match Purchase Order numbers, SKU quantities, and price terms acknowledged on the corresponding EDI 855 and ASN.

### 5.3 Payment Terms and Prompt Payment Discount

Standard payment terms are Net thirty (30) days from the date of physical receipt and acceptance of conforming merchandise at the destination Costco Depot. Costco shall be entitled to deduct a prompt payment cash discount of **two percent (2.0%)** from the gross invoice total if payment is remitted within ten (10) calendar days following invoice receipt (“2% 10, Net 30”).

### 5.4 Spoilage and Damage Allowance

In consideration of Costco handling minor, incidental carton crushing, exterior tray scuffs, or superficial package blemishes typical of high-velocity warehouse club handling without physical product returns, Vendor grants to Costco an off-invoice Damage and Swell Allowance of **one percent (1.0%)** on all gross invoice amounts. Costco shall automatically deduct this 1.0% credit on each invoice remittance. This allowance does not cover, nor release Vendor from liability for, manufacturer product recalls, hidden adulteration, or structural bag ruptures.

### 5.5 Right of Set-Off

Costco reserves the unqualified right to set off and deduct any compliance chargebacks, OTIF penalties, shortage assessments, ASN fines, pallet restacking fees, damaged goods deductions, or indemnification obligations accrued by Vendor under this Agreement against any outstanding or future accounts payable balances owed to Vendor.

---

## 6. QUALITY CONTROL, CLUB MERCHANDISE PACKAGING, AND FSMA COMPLIANCE

### 6.1 Receipt and Quality Inspection

Costco reserves the right to inspect all incoming shipments for organoleptic quality, packaging seal integrity, foreign material absence, and temperature history. Signing a delivery receipt or offloading freight does not constitute acceptance of latent defects or non-conforming goods. Costco may reject and return any shipment exhibiting pest infestation, broken seal tapes, wet packaging, or moisture damage at Vendor’s sole cost and risk.

### 6.2 Food Safety and Preventive Controls

Vendor warrants and represents that all pet food and treat consumables are manufactured in full compliance with the FDA Food Safety Modernization Act (FSMA), Hazard Analysis and Critical Control Points (HACCP) principles, and Current Good Manufacturing Practices (cGMP) under 21 CFR Part 507. Vendor shall maintain comprehensive lot traceability enabling forward and backward trace within four (4) hours of notification.

### 6.3 Product Recalls and Critical Withdrawals
...
If Vendor disputes the contractual validity, calculation accuracy, or factual justification of any compliance chargeback, deduction, or penalty assessed under Section 4, Vendor must submit a formal electronic dispute claim via the Costco Vendor Inquiry System (CVIS) within **thirty (30) calendar days** from the date of the deduction remittance advice. Any deduction not disputed within thirty (30) days shall be deemed conclusively final, binding, and waived by Vendor.

### 7.2 Required Evidentiary Substantiation

To be eligible for review and reversal, each dispute notice must include:
...
### 7.3 Reconciliation Timeline

Costco Vendor Accounting shall review properly submitted dispute documentation and render a formal written determination within forty-five (45) calendar days of receipt. If Costco verifies that the deduction resulted from Costco depot dock congestion, TMS appointment scheduling errors, or carrier telematics confirm on-time gate arrival, Costco shall credit the disputed amount back to Vendor on the next scheduled payment remittance cycle.
...
Vendor warrants that all Products delivered under this Agreement shall:
