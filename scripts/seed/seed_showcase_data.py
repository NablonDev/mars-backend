    ...
    with db.session() as session:
        ...
        if len(existing_penalties) < 15:
            ...
            monthly_fines_plan = [
                ...
                (1, 15, walmart, walmart_pos[0], "OTIF_LATE", Decimal("1080.00"), "PAID"),
                (1, 20, amazon, amazon_pos[0], "SHORT_SHIP", Decimal("672.00"), "PAID"),
                (1, 25, costco, costco_po, "ASN_LATE", Decimal("250.00"), "PAID"),
                (2, 12, walmart, walmart_pos[0], "SHORT_SHIP", Decimal("540.00"), "PAID"),
                (2, 18, amazon, amazon_pos[0], "OTIF_LATE", Decimal("672.00"), "PAID"),
                (2, 22, costco, costco_po, "PALLET_NON_COMPLIANCE", Decimal("1000.00"), "PAID"),
                (
                    3,
                    10,
                    walmart,
                ...
                (3, 28, costco, costco_po, "SHORT_SHIP", Decimal("2184.00"), "PAID"),
                (4, 8, walmart, walmart_pos[0], "SHORT_SHIP", Decimal("1080.00"), "PAID"),
                (4, 19, amazon, amazon_pos[0], "OTIF_LATE", Decimal("672.00"), "PAID"),
                (4, 24, costco, costco_po, "OTIF_LATE", Decimal("2184.00"), "PAID"),
                (
                    5,
                    14,
                    walmart,
                ...
                (5, 27, costco, costco_po, "BARCODE_UNREADABLE", Decimal("420.00"), "PAID"),
                (6, 11, walmart, walmart_pos[0], "ASN_LATE", Decimal("250.00"), "PAID"),
                (6, 18, amazon, amazon_pos[0], "OTIF_LATE", Decimal("672.00"), "PAID"),
                (6, 25, costco, costco_po, "SHORT_SHIP", Decimal("2184.00"), "PAID"),
                (7, 9, walmart, walmart_pos[0], "OTIF_LATE", Decimal("1080.00"), "PAID"),
                (
                    7,
                    16,
                    amazon,
                ...
                (7, 23, costco, costco_po, "OTIF_LATE", Decimal("2184.00"), "PAID"),
                (
                    8,
                    12,
                    walmart,
                ...
                (8, 26, costco, costco_po, "SHORT_SHIP", Decimal("2184.00"), "PAID"),
                (9, 5, walmart, walmart_pos[0], "OTIF_LATE", Decimal("1080.00"), "RESOLVED"),
                (9, 10, amazon, amazon_pos[0], "SHORT_SHIP", Decimal("672.00"), "DISPUTED"),
                (9, 15, costco, costco_po, "OTIF_LATE", Decimal("2184.00"), "DISPUTED"),
            ]
        ...
        if len(existing_disputes) == 0:
            ...
            dispute_specs: list[dict[str, Any]] = [
                ...
                {
                    "num": "DSP-2026-002",
                    "pen": pen_map.get("ACT-2026-0926"),
                    "po": amazon_pos[0],
                    "claimed": Decimal("672.00"),
                    "computed": Decimal("168.00"),
                    "verdict": DisputeVerdict.PAY_PARTIAL.value,
                    "status": DisputeStatus.ANALYZED.value,
                    "reason": DisputeReasonCode.QTY_CONFIRMED.value,
                    "notes": "POD signed by Amazon sorting supervisor verifies 1,170 cases received vs 900 scanned at intake dock. Reclaiming $504.00 difference.",
                    "due_date": datetime.date(2026, 9, 23),  # 5 days left
                },
                {
                    "num": "DSP-2026-003",
                    "pen": pen_map.get("ACT-2026-0927"),
                    "po": costco_po,
                    "claimed": Decimal("2184.00"),
                    "computed": None,
                    "verdict": None,
                ...
                {
                    "num": "DSP-2026-004",
                    "pen": pen_map.get("ACT-2026-0822"),
                    "po": walmart_pos[1] if len(walmart_pos) > 1 else walmart_pos[0],
                    "claimed": Decimal("810.00"),
                    "computed": None,
                    "verdict": None,
                    "status": DisputeStatus.OPEN.value,
                    "reason": DisputeReasonCode.NOT_LATE.value,
                ...
                {
                    "num": "DSP-2026-005",
                    "pen": pen_map.get("ACT-2026-0720"),
                    "po": amazon_pos[1] if len(amazon_pos) > 1 else amazon_pos[0],
                    "claimed": Decimal("630.00"),
                    "computed": Decimal("315.00"),
                    "verdict": DisputeVerdict.PAY_PARTIAL.value,
                    "status": DisputeStatus.RESOLVED.value,
                    "reason": DisputeReasonCode.AMOUNT_INCORRECT.value,
                    "notes": "Rate assessed at 5.0% tier ($630.00) rather than contractually agreed 2.5% tier ($315.00). Amazon Vendor Central approved $315.00 credit refund.",
